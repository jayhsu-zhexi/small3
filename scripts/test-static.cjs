...
(async () => {
  ...
  try {
    ...
    for(const asset of ['memory-engine.js','memory-records.js','memory-ui.js','memory-audio.js','memory.css','memory-home.css','memory-cards.css', 'memory-cinematics.css', 'memory-control-discs.webp', 'memory-result-win.webp', 'memory-result-loss.webp','memory-card-shells.webp','memory-equipment-1.webp','memory-equipment-2.webp','memory-home-v2.webp', 'memory-controls.webp', 'memory-title.webp', 'memory-home-icons.webp','memory-icons.svg','memory-background.webp','attention-ui.js','attention.css','detective-ui.js','detective.css','board-engine.js','board-ui.js','board-audio.js','board-bank.js','board-records.js','board.css','board-island.png']){
