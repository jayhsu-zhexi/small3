...
(async () => {
  ...
  try {
    ...
    for(const asset of ['memory-engine.js','memory-ui.js','memory-audio.js','memory.css','memory-home.css','memory-home-v2.png', 'memory-controls.png','memory-icons.svg','memory-background.png','attention-ui.js','attention.css','detective-ui.js','detective.css','board-engine.js','board-ui.js','board-audio.js','board-bank.js','board-records.js','board.css','board-island.png']){
