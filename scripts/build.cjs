...
const files = ['index.html', 'board.html', 'assets/backup.js', 'assets/board-engine.js', 'assets/board-bank.js', 'assets/board-ui.js', 'assets/board-records.js', 'assets/board.css', 'assets/board-island.png'];
