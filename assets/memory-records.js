(function(root){
  'use strict';
  const COUNTS=[16,32,52,74,108],SECONDS={16:180,32:240,40:270,52:300,74:420,108:540};
  ...
  function validRun(value){
    return value&&Number.isInteger(value.size)&&value.size%2===0&&[16,24,32,40,52,74,108].some((base,i)=>value.size>=base&&value.size<=base+[2,4,4,6,8,10,12][i])&&validTime(value.duration)&&['won','lost'].includes(value.outcome)&&
